...
const work = Vue.createApp({
  data() {
    return {
      ...
      SKtools:['Vue','D3.js','Flask','NoSQL','Azure']
    }
  }
})
  ...
  data() {
    return {
      skills: [{
        ...
        title: 'Front-end',
        list: [
          "Basic：HTML｜CSS｜RWD｜JavaScript｜SCSS",
...
const portfolio = Vue.createApp({
  data() {
    return {
      ...
      typesEnglish: [
        { name: 'analysis', current: true },
        { name: 'frontend', current: false },
        { name: 'ML/DL', current: false },
      ...
      portfolioList: [
        ...
        {
          type: 'frontend',
          link: 'https://youtu.be/gRhVQECibQw',
          img: 'web6.jpg',
          title: '新光金控實習 - 社群輿論資料分析平台',
          time: '2022/07~2022/09',
          content: '透過爬蟲爬取PTT、App store、Google play等社群輿論資料，利用資料視覺化開發一客製化輿論分析平台',
          subtitle: '※使用工具：',
          list: ['Backend:Flask', 'Frontend:Vue, D3.js', 'Database：Azure cosmos DB(NoSQL)', 'Clawer：Python( BeautifulSoup, Selenium )'],
          keyword: ['Vue', 'D3.js', 'Flask', 'NoSQL', 'Azure'],
        },
        {
          type: 'frontend',
          link: 'https://william50307.github.io/Netflix_Data_Visulization/nevi.html',
          img: 'web5.jpg',
          title: '資料視覺化 - Netflix data visualization',
          time: '2022/04~2022/06',
          content: '利用D3.js將Netflix進行資料視覺化並且使用網頁呈現，完成多種資料視覺化呈現',
          subtitle: '※負責內容：',
          list: ['平台設計、開發', 'IMDB評論文字雲', '演員演出網路圖', '平行座標圖'],
          keyword: ['D3.js', 'Tailwind CSS', 'Data visualization'],
        },
        {
          type: 'frontend',
